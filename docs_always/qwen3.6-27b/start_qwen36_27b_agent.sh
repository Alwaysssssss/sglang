...
SERVED_MODEL_NAME="${SERVED_MODEL_NAME:-qwen3.6-27b-agent}"
...
MEMORY_TARGET_FRACTION="${MEMORY_TARGET_FRACTION:-0.90}"
...
LOG_REQUESTS_LEVEL="${LOG_REQUESTS_LEVEL:-1}"
LOG_REQUESTS_FORMAT="${LOG_REQUESTS_FORMAT:-json}"
DECODE_LOG_INTERVAL="${DECODE_LOG_INTERVAL:-32}"
