...
BASE_URL = "http://127.0.0.1:31083"
INPUT_VIDEO = Path("/home/zhiheng/Vivid-VR/input/720p/test_video_960x720.mp4")
...
def main() -> int:
    ...
    task_id = f"vividvr-service-short-70f-50step-sp2-{time.strftime('%Y%m%dT%H%M%SZ', time.gmtime())}"
